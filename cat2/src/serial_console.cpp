...
static void handle(char *s) {
  ...
  if(!strcmp(cmd,"control")) {
    ...
    else if(arg&&!strcmp(arg,"source")) { if(arg2&&!strcmp(arg2,"1"))setFlowFeedbackSource(FLOW_SENSOR_1); else if(arg2&&!strcmp(arg2,"2"))setFlowFeedbackSource(FLOW_SENSOR_2); else if(arg2&&!strcmp(arg2,"avg"))setFlowFeedbackSource(FLOW_AVERAGE_OF_VALID); else help(); }
